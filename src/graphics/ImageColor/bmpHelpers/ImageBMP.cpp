 ...
 */
bool ImageColor::legalBmp(bitmapHeader *bmpHeader)
{
 ...
 */
void ImageColor::readBmpHeaderSd(SdFile *_f, bitmapHeader *_h)
{
    uint8_t header[55];
 ...
 *              Bitmap image header to save data to
 */
void ImageColor::readBmpHeader(uint8_t *buf, bitmapHeader *_h)
{
 ...
 */
bool ImageColor::drawBitmapFromSd(const char *fileName, int x, int y, bool dither, bool invert)
{
    SdFile dat;
 ...
 * @return      1 if drawn successfully, 0 if not
 */
bool ImageColor::drawBitmapFromSd(SdFile *p, int x, int y, bool dither, bool invert)
{
 ...
 * @return      1 if drawn successfully, 0 if not
 */
bool ImageColor::drawBitmapFromWeb(const char *url, int x, int y, bool dither, bool invert)
{
    bool ret = 0;
 ...
 * @return      1 if drawn successfully, 0 if not
 */
bool ImageColor::drawBitmapFromWeb(WiFiClient *s, int x, int y, int32_t len, bool dither, bool invert)
{
    bool ret = 0;
 ...
 * @return      1 if drawn successfully, 0 if not
 */
bool ImageColor::drawBitmapFromBuffer(uint8_t *buf, int x, int y, bool dither, bool invert)
{
 ...
 *              1 if using invert, 0 if not
 */
void ImageColor::displayBmpLine(int16_t x, int16_t y, bitmapHeader *bmpHeader, bool dither, bool invert)
{
