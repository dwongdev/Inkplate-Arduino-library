...
extern ImageColor *_imagePtrPng;
 ...
 * @return      1 if drawn successfully, 0 if not
 */
bool ImageColor::drawPngFromSd(SdFile *p, int x, int y, bool dither, bool invert)
{
    _pngDither = dither;
    _pngInvert = invert;
    lastY = y;
 ...
 * @return      1 if drawn successfully, 0 if not
 */
bool ImageColor::drawPngFromWeb(const char *url, int x, int y, bool dither, bool invert)
{
    _pngDither = dither;
    _pngInvert = invert;
    lastY = y;
 ...
 * @return      1 if drawn successfully, 0 if not
 */
bool ImageColor::drawPngFromWeb(WiFiClient *s, int x, int y, int32_t len, bool dither, bool invert)
{
    _pngDither = dither;
    _pngInvert = invert;
    lastY = y;
