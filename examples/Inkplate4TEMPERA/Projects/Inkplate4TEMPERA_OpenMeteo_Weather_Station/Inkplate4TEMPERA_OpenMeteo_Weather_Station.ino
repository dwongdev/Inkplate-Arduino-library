/*
  Inkplate4TEMPERA OpenMeteo Weather Station Example
  Compatible with Soldered Inkplate 4 Tempera -> https://soldered.com/documentation/inkplate/projects/open-meteo-weather-station
