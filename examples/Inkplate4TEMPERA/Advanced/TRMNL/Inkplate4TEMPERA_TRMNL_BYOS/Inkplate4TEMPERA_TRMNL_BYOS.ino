/**
 **************************************************
 * @file        Inkplate4TEMPERA_TRMNL_BYOS.ino
 * @brief       TRMNL BYOS client example for Soldered Inkplate 4 TEMPERA.
 *
 * @details     Connects Inkplate 4 TEMPERA to WiFi, registers with a
