/**
 **************************************************
 * @file        Inkplate4TEMPERA_HTTPS_With_Certificate.ino
 * @brief       Secure HTTPS image download using a pinned certificate (Inkplate 4TEMPERA).
 *
 ...
 *              validation. The example connects Inkplate 4TEMPERA to WiFi, applies
