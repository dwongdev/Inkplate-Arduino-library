/**
 **************************************************
 * @file        Inkplate4TEMPERA_HTTP_Request.ino
 * @brief       Simple HTTP web content fetch example for Soldered Inkplate 4TEMPERA.
 *
...
void setup()
{
    ...
    display.setCursor(30, 30);                        // Set print position
    ...
    else
    {
        ...
        for (int i = 0; i < n; i++)
        {
            display.print("\n    "); // Print some spaces so it's aligned so it's visible on the ePaper
    ...
    display.setCursor(30, 30);         // Set print cursor to new position
