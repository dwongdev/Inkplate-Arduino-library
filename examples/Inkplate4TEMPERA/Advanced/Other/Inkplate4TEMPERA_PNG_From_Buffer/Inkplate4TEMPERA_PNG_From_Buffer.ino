/**
 **************************************************
 * @file        Inkplate4TEMPERA_PNG_From_Buffer.ino
 * @brief       Display a PNG image loaded into a RAM buffer on Soldered Inkplate 4 TEMPERA.
 *
 ...
 *
 * Configuration:
 * - Boards Manager -> Inkplate Boards -> Inkplate 4 TEMPERA
 * - SD card format: FAT / FAT32
 * - PNG resolution should not exceed 600 x 600 pixels
 *
