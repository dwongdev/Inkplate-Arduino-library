/**
 **************************************************
 * @file        Inkplate4TEMPERA_Peripheral_Mode.ino
 * @brief       Runs Inkplate 4TEMPERA in “Peripheral Mode”, accepting UART commands
 *              to control the e-paper display without custom Arduino drawing
 *              code.
 *
 * @details     This example turns Inkplate 4TEMPERA into a serial-controlled display
