/*
   Inkplate6COLOR_Image_Frame_From_SD example for Soldered Inkplate 6COLOR
   For this example you will need a micro USB cable, Inkplate 6COLOR and a SD card loaded with images.
   ...
   Make sure that the image has a resolution smaller than 600x448 or otherwise it won't fit on the screen.
...
void setup()
{
    ...
    display.setTextSize(2);      // Scale text to be five times bigger then original (5x7 px)
}
