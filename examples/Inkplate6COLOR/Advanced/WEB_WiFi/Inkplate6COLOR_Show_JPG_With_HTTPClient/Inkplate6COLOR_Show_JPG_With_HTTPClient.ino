/*
   Inkplate6COLOR_Show_JPG_With_HTTPClient example for Soldered Inkplate 6COLOR
   For this example you will need a USB-C cable, Inkplate 6COLOR, and an available WiFi connection.
