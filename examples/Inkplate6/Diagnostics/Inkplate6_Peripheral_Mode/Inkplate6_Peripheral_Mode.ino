/**
 **************************************************
 * @file        Inkplate6_Peripheral_Mode.ino
 * @brief       Runs Inkplate 6 in “Peripheral Mode”, accepting UART commands
 *              to control the e-paper display without custom Arduino drawing
 *              code.
 *
 * @details     This example turns Inkplate 6 into a serial-controlled display
 ...
 * - Hardware:   Inkplate 6, USB-C cable
