/**
 **************************************************
 * @file        Inkplate6_Set_VCOM.ino
 * @brief       Reads and programs the Inkplate 6 EPD VCOM voltage via Serial.
 *
 ...
 * - If programming fails, verify you selected the correct Inkplate 6 board and
