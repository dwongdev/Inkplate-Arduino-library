/**
 **************************************************
 * @file        Inkplate6_Google_Calendar.ino
 * @brief       Google Calendar dashboard example for Soldered Inkplate 6.
 *
 * @details     Demonstrates how to use Inkplate 6 as a low-power Google
