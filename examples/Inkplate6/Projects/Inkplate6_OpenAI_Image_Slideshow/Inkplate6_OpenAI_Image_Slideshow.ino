/*
  Inkplate6 OpenAI Image slideshow
  Compatible with Soldered Inkplate 6

  For this example you will need only USB cable and Inkplate 6.
  Select "Soldered Inkplate6" from Tools -> Board menu.
  Don't have "Soldered Inkplate6" option? Follow our tutorial and add it:https://soldered.com/documentation/inkplate/6/quick-start-guide/
...
String imagePrompt = "Create an album cover with the title 'Cats' and have two cats with sunglasses";
