/**
 **************************************************
 * @file        Inkplate6_OpenMeteo_Weather_Station.ino
 ...
 *              dashboard on Inkplate 6 using Open-Meteo as the data source.
 ...
 * - Hardware:   Inkplate 6, USB cable (battery recommended for deployment)
 ...
 * 2) Upload the sketch to Inkplate 6 and open Serial Monitor (115200) for logs.
