/**
 **************************************************
 * @file        Inkplate6_EEPROM_Usage.ino
 * @brief       EEPROM read/write example for Soldered Inkplate 6.
 *
 * @details     Demonstrates how to use the built-in EEPROM on Inkplate 6 to
...
void setup()
{
    ...
    // Init EEPROM library with 512 of EEPROM size.
