/**
 **************************************************
 * @file        Inkplate6_PNG_From_Buffer.ino
 * @brief       Display a PNG image loaded into a RAM buffer on Soldered Inkplate 6.
 *
 ...
 * - PNG resolution should not exceed 800 x 600 pixels
 *
