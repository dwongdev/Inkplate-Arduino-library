/**
 **************************************************
 * @file        Inkplate6_RTC_Interrupt_Alarm.ino
 * @brief       RTC alarm with interrupt example for Soldered Inkplate 6.
 *
 ...
 *              Inkplate 6. The example shows how to set time and date,
