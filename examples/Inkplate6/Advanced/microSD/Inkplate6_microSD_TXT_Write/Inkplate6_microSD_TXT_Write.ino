/**
 **************************************************
 * @file        Inkplate6_SD_TXT_Write.ino
 * @brief       Write text file to SD card on Soldered Inkplate 6.
 *
...
char *dataToWrite = "Hello! This is the file writing example for Inkplate 6.\n"; // "\n" represents a new line
