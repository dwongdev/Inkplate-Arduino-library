/**
 **************************************************
 * @file        Inkplate6_HTTP_Web_Server.ino
 * @brief       Standalone WiFi web server example for Soldered Inkplate 6.
 *
 * @details     Demonstrates how to use Inkplate 6 as a simple standalone
