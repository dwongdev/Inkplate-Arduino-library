/*
   Inkplate6_Show_JPG_With_HTTPClient example for Soldered Inkplate 6
   For this example you will need a USB-C cable, Inkplate 6, and an available WiFi connection.
