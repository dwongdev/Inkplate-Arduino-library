/**
 **************************************************
 * @file        Inkplate6_HTTPS_With_Certificate.ino
 * @brief       Secure HTTPS image download using a pinned certificate (Inkplate 6).
 *
 ...
 *              validation. The example connects Inkplate 6 to WiFi, applies
