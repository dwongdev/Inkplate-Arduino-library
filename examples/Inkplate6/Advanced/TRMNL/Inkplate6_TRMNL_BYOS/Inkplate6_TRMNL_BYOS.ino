/**
 **************************************************
 * @file        Inkplate6_TRMNL_BYOS.ino
 * @brief       TRMNL BYOS client example for Soldered Inkplate 6.
 *
 * @details     Connects Inkplate 6 to WiFi, registers with a TRMNL-compatible
 *              BYOS server via /api/setup, then polls /api/display on a loop,
 *              drawing whatever image the server returns and deep-sleeping
 *              between refreshes.
 *
 * Requirements:
 * - Board:      e-radionica Inkplate6 or Soldered Inkplate6
