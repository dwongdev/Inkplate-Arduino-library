...
// Other option is gray mode, which is demonstrated in next example "Inkplate6_Grayscale"
...
// Array that holds data for bitmap image of 700x140 pixels. You can convert your own image using Inkplate Image Converter.
#include "logo.h"
int logo_w = 700;
int logo_h = 140;
