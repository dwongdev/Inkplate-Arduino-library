...
void setup()
{
    ...
    if (!display.rtc.IsSet())
    {
        ...
        display.rtc.SetDate(3, 5, 4, 2023); // 0 for Sunday, 1 for Monday, ... for example Wensday, 5.4.2023.

        // display.rtc.SetEpoch(1680676200); // Or use epoch for setting the time and date
    }
