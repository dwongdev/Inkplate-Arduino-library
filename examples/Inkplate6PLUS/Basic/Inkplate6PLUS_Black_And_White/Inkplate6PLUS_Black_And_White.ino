...
// Other option is gray mode, which is demonstrated in next example "Inkplate6PLUS_Grayscale"

#define DELAY_MS                                                                                                       \
    5000 // Delay in milliseconds between screen refresh. Refreshing e-paper screens more often than 5s is not
         // recommended
// Want to refresh faster? Use partial update! Find example in "Inkplate6PLUS_Partial_Update"
