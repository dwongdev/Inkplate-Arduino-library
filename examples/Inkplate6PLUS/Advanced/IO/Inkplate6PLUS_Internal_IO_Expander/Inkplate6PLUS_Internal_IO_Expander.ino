/*
   Inkplate6PLUS_Internal_IO_Expander example for Soldered Inkplate 6Plus
   For this example you will need only a micro USB cable, Soldered Inkplate 6Plus, 330 Ohm resistor and LED diode.
