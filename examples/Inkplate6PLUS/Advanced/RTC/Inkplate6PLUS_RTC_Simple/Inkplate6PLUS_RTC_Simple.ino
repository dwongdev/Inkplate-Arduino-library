/**
 **************************************************
 * @file        Inkplate6PLUS_RTC_Simple.ino
 * @brief       Basic RTC time and date example for Soldered Inkplate 6PLUS.
 *
 * @details     Demonstrates basic usage of the PCF85063A real-time clock (RTC)
 *              integrated on the Inkplate 6PLUS board. The example shows how to
