/**
 **************************************************
 * @file        Inkplate6PLUS_Qwiic.ino
 * @brief       I2C (Qwiic) scanner example for Soldered Inkplate 6PLUS.
 *
 ...
 *              the Inkplate 6PLUS e-paper display. Useful for validating proper
 *              wiring and confirming device communication.
 *
 * Requirements:
 * - Board:      Soldered Inkplate 6PLUS
 * - Hardware:   Inkplate 6PLUS, USB cable, optional Qwiic/I2C device
 * - Extra:      None
 *
 * Configuration:
