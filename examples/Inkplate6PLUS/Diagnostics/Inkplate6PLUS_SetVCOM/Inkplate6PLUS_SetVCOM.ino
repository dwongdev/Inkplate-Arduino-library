/**
 **************************************************
 * @file        Inkplate6PLUS_Set_VCOM.ino
 * @brief       Reads and programs the Inkplate 6PLUS EPD VCOM voltage via Serial.
 *
 ...
 * - If programming fails, verify you selected the correct Inkplate 6PLUS board and
