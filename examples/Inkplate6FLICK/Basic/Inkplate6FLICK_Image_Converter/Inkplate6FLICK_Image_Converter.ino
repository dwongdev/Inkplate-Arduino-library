/**
 **************************************************
 * @file        Inkplate6FLICK_Image_Converter.ino
 * @brief       Example showing how to display an image on Inkplate 6FLICK
 *              using the Soldered Image Converter tool.
 *
 * @details     This example demonstrates how to use the Soldered Image
 *              Converter to prepare an image for display on Inkplate 6FLICK.
 ...
 *
 * Expected output:
 * - Your converted image displayed on the Inkplate 6FLICK e-paper screen.
 *
 * Notes:
...
#error "Wrong board selection for this example, please select Soldered Inkplate6FLICK in the boards menu."
#endif
