/**
 **************************************************
 * @file        Inkplate6FLICK_Grayscale.ino
 * @brief       Grayscale graphics demo for Soldered Inkplate 6FLICK.
 *
...
void loop()
{
    ...
    { // Write 1000 random colored pixels at random locations
        display.drawPixel(random(0, 1023), random(0, 757),
    ...
    display.drawLine(1023, 0, 0, 757, 0); // with those. Arguments are: start X, start Y, ending X, ending Y, color.
    ...
    for (int i = 0; i < 100; i++)
    {
        display.drawLine(random(0, 1023), random(0, 757), random(0, 1023), random(0, 757), random(0, 7));
    }
    ...
    for (int i = 0; i < 100; i++)
    {
        display.drawThickLine(random(0, 1023), random(0, 757), random(0, 1023), random(0, 757), random(0, 7),
                              (float)random(1, 20));
    }
    ...
    for (int i = 0; i < 100; i++)
    {
        ...
        display.drawGradientLine(random(0, 1023), random(0, 757), random(0, 1023), random(0, 757), startColor, endColor,
                                 (float)random(1, 20));
    }
    ...
    for (int i = 0; i < 50; i++)
    {
        display.drawRoundRect(random(0, 1023), random(0, 757), 100, 150, 5, random(0, 7));
    }
    ...
    for (int i = 0; i < 50; i++)
    {
        display.fillRoundRect(random(0, 1023), random(0, 757), 30, 30, 3, random(0, 7));
    }
