/**
 **************************************************
 * @file        Inkplate6FLICK_IO_Expanders.ino
 * @brief       Internal and external IO expander control example for Soldered Inkplate 6FLICK.
 *
 * @details     Demonstrates how to control GPIO pins on both the internal and
 *              external IO expanders available on Inkplate 6FLICK. The example
 ...
 * - Hardware:   Inkplate 6FLICK, USB cable, 2× LED, 2× 330 Ω resistors
 * - Extra:      None
 *
 * Configuration:
