/*
   Inkplate6FLICK_External_IO_Expander example for Soldered Inkplate 6FLICK
   For this example you will need only a micro USB cable, Inkplate 6FLICK, 330 Ohm resistor and LED diode.
