/*
   Inkplate6FLICK_Show_JPG_With_HTTPClient example for Soldered Inkplate 6FLICK
   For this example you will need a USB-C cable, Inkplate 6FLICK, and an available WiFi connection.
...
String url = "https://raw.githubusercontent.com/SolderedElectronics/Inkplate-Arduino-library/dev/examples/Inkplate6FLICK/Advanced/WEB_WiFi/Inkplate6FLICK_Show_JPG_With_HTTPClient/image.jpg";
