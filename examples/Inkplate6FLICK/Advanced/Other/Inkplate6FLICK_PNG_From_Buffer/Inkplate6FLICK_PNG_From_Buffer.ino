/**
 **************************************************
 * @file        Inkplate6FLICK_PNG_From_Buffer.ino
 * @brief       Display a PNG image loaded into a RAM buffer on Soldered Inkplate 6FLICK.
 *
 ...
 *
 * Configuration:
 * - Boards Manager -> Inkplate Boards -> Soldered Inkplate 6FLICK
