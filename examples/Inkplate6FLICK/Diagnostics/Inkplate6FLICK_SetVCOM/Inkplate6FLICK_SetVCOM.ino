/**
 **************************************************
 * @file        Inkplate6FLICK_Set_VCOM.ino
 * @brief       Reads and programs the Inkplate 6FLICK EPD VCOM voltage via Serial.
 *
 ...
 * - If programming fails, verify you selected the correct Inkplate 6FLICK board and
