/*
  Inkplate5V2 Image Uploader Example
  Compatible with Soldered Inkplate 5V2 -> https://soldered.com/documentation/inkplate/projects/image-uploader

  Getting Started with Inkplate:
  For setup and documentation, visit: https://soldered.com/documentation/inkplate

  Overview:
  This example demonstrates how to upload an image to a webapp hosted by Inkplate 5V2
