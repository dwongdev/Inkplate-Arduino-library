/**
 **************************************************
 * @file        Inkplate5V2_Image_Converter.ino
 * @brief       Example showing how to display an image on Inkplate 5V2
 *              using the Soldered Image Converter tool.
 *
 * @details     This example demonstrates how to use the Soldered Image
 *              Converter to prepare an image for display on Inkplate 5V2.
 ...
 *              2. Upload your image and select "Inkplate 5V2" as the target board.
 ...
 * 3) Select "Soldered Inkplate5V2" from Tools → Board.
 * 4) Upload the sketch to Inkplate 5V2.
 * 5) The image appears on the display after initialization.
 *
 * Expected output:
 * - Your converted image displayed on the Inkplate 5V2 e-paper screen.
 *
 * Notes:
