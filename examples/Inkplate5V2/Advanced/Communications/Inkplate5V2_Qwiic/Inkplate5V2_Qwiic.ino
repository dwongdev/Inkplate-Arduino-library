/**
 **************************************************
 * @file        Inkplate5v2_Qwiic.ino
 * @brief       I2C (Qwiic) scanner example for Soldered Inkplate 5v2.
 *
 ...
 *              the Inkplate 5v2 e-paper display. Useful for validating proper
 *              wiring and confirming device communication.
 *
 * Requirements:
 * - Board:      Soldered Inkplate 5v2
 * - Hardware:   Inkplate 5v2, USB cable, optional Qwiic/I2C device
 * - Extra:      None
 *
 * Configuration:
