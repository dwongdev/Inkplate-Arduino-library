/**
 **************************************************
 * @file        Inkplate5v2_RTC_Alarm.ino
 * @brief       RTC time and alarm example for Soldered Inkplate 5v2.
 *
 * @details     Demonstrates how to use the PCF85063 real-time clock (RTC)
 *              integrated on the Inkplate 5v2 board. The example shows how
 ...
 *
 * Notes:
 * - Inkplate 5v2 uses the PCF85063 RTC chip.
