/**
 **************************************************
 * @file        Inkplate5v2_RTC_Interrupt_Alarm.ino
 * @brief       RTC alarm with interrupt example for Soldered Inkplate 5v2.
 *
 ...
 *              Inkplate 5v2. The example shows how to set time and date,
