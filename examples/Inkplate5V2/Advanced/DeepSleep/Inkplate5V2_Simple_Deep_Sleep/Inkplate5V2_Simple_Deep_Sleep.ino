/**
 **************************************************
 * @file        Inkplate5v2_Simple_Deep_Sleep.ino
 * @brief       Simple deep sleep slideshow example for Soldered Inkplate 5v2.
 *
 * @details     Demonstrates low-power operation on Inkplate 5v2 using ESP32 deep
...
void setup()
{
    ...
    display.image.draw(pictures[slide], 0, 0, E_INK_WIDTH, E_INK_HEIGHT); // Display selected picture at location X=0, Y=0. All three pictures have
