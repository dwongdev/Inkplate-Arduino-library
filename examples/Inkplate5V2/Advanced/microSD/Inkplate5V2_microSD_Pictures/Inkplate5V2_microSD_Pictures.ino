/**
 **************************************************
 * @file        Inkplate5v2_SD_Pictures.ino
 * @brief       Display images from SD card on Soldered Inkplate 5v2.
 *
 * @details     Demonstrates how to load image files from an SD card and display
 *              them on the Inkplate 5v2 e-paper display. The example shows how to
 ...
 * - Maximum supported resolution is 1024 × 758 pixels.
