/**
 **************************************************
 * @file        Inkplate5v2_HTTP_Web_Server.ino
 * @brief       Standalone WiFi web server example for Soldered Inkplate 5v2.
 *
 * @details     Demonstrates how to use Inkplate 5v2 as a simple standalone
