/**
 **************************************************
 * @file        Inkplate5_Black_And_White.ino
 * @brief       Black & white drawing demo using Adafruit GFX on Soldered Inkplate 5.
 *
 * @details     Demonstrates basic drawing and text rendering on the Inkplate 5
...
void loop()
{
    ...
    display.clearDisplay();
    display.image.draw(logo, 75, 200, logo_w, logo_h,
