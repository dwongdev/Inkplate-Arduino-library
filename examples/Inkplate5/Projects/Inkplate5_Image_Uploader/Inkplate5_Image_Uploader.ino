/*
  Inkplate5 Image Uploader Example
  Compatible with Soldered Inkplate 5 -> https://soldered.com/documentation/inkplate/projects/image-uploader

  Getting Started with Inkplate:
  For setup and documentation, visit: https://soldered.com/documentation/inkplate

  Overview:
  This example demonstrates how to upload an image to a webapp hosted by Inkplate 5
...
void handleUpload() {
  ...
  if (u.status == UPLOAD_FILE_START) {
    ...
    if (imageBufCapacity <= 0) {
      // Fallback capacity if header is missing or invalid (~960×540 pixels)
      imageBufCapacity = 960 * 540;
    }
