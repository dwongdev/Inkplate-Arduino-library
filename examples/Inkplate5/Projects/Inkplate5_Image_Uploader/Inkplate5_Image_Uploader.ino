/**
 **************************************************
 * @file        Inkplate5_Image_Uploader.ino
 * @brief       Local web image uploader and display example for Soldered Inkplate 5.
 *
 * @details     Demonstrates how to host a small web app directly on Inkplate 5
