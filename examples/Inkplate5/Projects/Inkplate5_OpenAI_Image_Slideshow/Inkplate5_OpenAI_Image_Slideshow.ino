...
String imagePrompt = "Generate an beautiful forest and mountain scene. Above is a clear blue sky and below is a lake.";
...
void setup() {
  ...
  display.display(); // Update message after URL is fetched
