/**
 **************************************************
 * @file        Inkplate5_Maze_Generator.ino
 * @brief       Generates a random maze and draws it on Inkplate 5 in 1-bit
 *              black/white mode.
 *
 * @details     This example demonstrates simple procedural content generation
 *              on Inkplate 5 by creating a new random maze at startup and
