/**
 **************************************************
 * @file        Inkplate5_Qwiic.ino
 * @brief       I2C (Qwiic) scanner example for Soldered Inkplate 5.
 *
 ...
 *              the Inkplate 5 e-paper display. Useful for validating proper
 *              wiring and confirming device communication.
 *
 * Requirements:
 * - Board:      Soldered Inkplate 5
 * - Hardware:   Inkplate 5, USB cable, optional Qwiic/I2C device
 * - Extra:      None
 *
 * Configuration:
