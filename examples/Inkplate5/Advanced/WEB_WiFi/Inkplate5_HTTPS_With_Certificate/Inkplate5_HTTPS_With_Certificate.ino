/**
 **************************************************
 * @file        Inkplate5_HTTPS_With_Certificate.ino
 * @brief       Secure HTTPS image download using a pinned certificate (Inkplate 5).
 *
 ...
 *              validation. The example connects Inkplate 5 to WiFi, applies
