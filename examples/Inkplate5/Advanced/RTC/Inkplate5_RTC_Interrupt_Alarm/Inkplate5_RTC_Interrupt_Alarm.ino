/**
 **************************************************
 * @file        Inkplate5_RTC_Interrupt_Alarm.ino
 * @brief       RTC alarm with interrupt example for Soldered Inkplate 5.
 *
 ...
 *              Inkplate 5. The example shows how to set time and date,
