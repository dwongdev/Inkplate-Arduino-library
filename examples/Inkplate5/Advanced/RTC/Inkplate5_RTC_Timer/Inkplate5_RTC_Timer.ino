/**
 **************************************************
 * @file        Inkplate5_RTC_Timer.ino
 * @brief       RTC timer functionality example for Soldered Inkplate 5.
 *
 * @details     Demonstrates how to use the PCF85063A real-time clock (RTC)
 *              timer functionality on the Inkplate 5 board. The example shows
