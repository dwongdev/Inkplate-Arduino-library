/*
   Inkplate7_Show_JPG_With_HTTPClient example for Soldered Inkplate 7
   For this example you will need a USB-C cable, Inkplate 7, and an available WiFi connection.
