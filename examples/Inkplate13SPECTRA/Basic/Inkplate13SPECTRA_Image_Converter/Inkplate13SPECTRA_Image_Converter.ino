 ...
 *
 * Configuration:
 * - Boards Manager -> Inkplate Boards -> Soldered Inkplate13SPECTRA
 *
 ...
 * 3) Select "Soldered Inkplate13SPECTRA" from Tools → Board.
 * 4) Upload the sketch to Inkplate 13SPECTRA.
 * 5) The image appears on the display after initialization.
 *
 * Expected output:
 * - Your converted image displayed on the Inkplate 13SPECTRA e-paper screen.
 *
 * Notes:
