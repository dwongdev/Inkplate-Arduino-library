 ...
 * @brief       Display a PNG image loaded into a RAM buffer on Soldered Inkplate 13 SPECTRA.
 *
 ...
 *
 * Requirements:
 * - Board:      Soldered Inkplate 13 SPECTRA
 * - Hardware:   Inkplate 13 SPECTRA, USB cable, microSD card
 ...
 * - PNG resolution should not exceed 1200 x 1600 pixels
 *
 * Don't have Inkplate Boards in Arduino Boards Manager?
 * See https://docs.soldered.com/inkplate/13spectra/quick-start-guide/
 *
 * How to use:
 * 1) Copy a PNG file named "image.png" to a FAT-formatted SD card.
 * 2) Insert the SD card into the Inkplate.
 * 3) Upload the sketch to Inkplate 13 SPECTRA.
