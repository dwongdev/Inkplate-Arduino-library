/**
 **************************************************
 * @file        Inkplate13SPECTRA_TRMNL_BYOS.ino
 * @brief       TRMNL BYOS client example for Soldered Inkplate 13SPECTRA.
 *
 * @details     Connects Inkplate 13SPECTRA to WiFi, registers with a
 ...
 *
 *              NOTE: Inkplate 13SPECTRA is a 6-color panel and has no fast
 *              partial-refresh call, so unlike the monochrome boards this
 *              sketch prints WiFi-connect progress dots to Serial only,
 *              instead of to the screen. Images fetched via image.draw()
 *              are automatically dithered to the 6-color palette.
 *
 * Requirements:
