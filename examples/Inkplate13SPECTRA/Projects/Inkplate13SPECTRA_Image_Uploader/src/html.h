...
<body>
  <div class="upload-section">
    ...
    <br>
    <p>Using this app you can easily upload pictures to your Inkplate board. Take a new photo (like a selfie) or browse from your gallery - then click upload to show the image on your Inkplate 13SPECTRA!</p>
    <br>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', () => {
      ...
      form.addEventListener('submit', function(e) {
        ...
        const img = new Image();
        img.onload = () => {
          // calculate scale to fit entire image into 600x448
