/**
 **************************************************
 * @file        Inkplate10_OpenAI_Image_Slideshow.ino
 * @brief       Generates an image from an OpenAI prompt (DALL·E), downloads it,
 *              shows it on Inkplate 10, then deep-sleeps between updates.
 *
 * @details     This example demonstrates an Internet-connected image slideshow
 *              powered by OpenAI image generation. On boot, Inkplate 10 connects
