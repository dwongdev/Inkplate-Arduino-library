/*
   Inkplate10_Image_Frame_From_SD example for Soldered Inkplate10
   For this example you will need a micro USB cable, Inkplate10 and a SD card loaded with images.
   ...
   Make sure that the image has a resolution smaller than 1200x825 or otherwise it won't fit on the screen.
