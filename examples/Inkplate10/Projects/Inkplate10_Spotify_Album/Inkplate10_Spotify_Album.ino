/*
    Inkplate10_Spotify_Album Example
    ...
    the Inkplate 10 e-paper display.
    ...
    Overview:
    Thie example demonstrates how to connect your Inkplate 10 to Spotify's WEB API service, parse received Json data and
